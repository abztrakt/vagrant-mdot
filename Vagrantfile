...
Vagrant.configure(2) do |config|
  ...
  ## UNCOMMENT THE FOLLOWING IF YOU NEED YOUR UPLOADS
  #config.vm.synced_folder "./html/itconnect/wp-content/uploads", "/vagrant/html/itconnect/wp-content/uploads",
  #  owner: "vagrant",
  #  group: "www-data",
  ...
  config.vm.provision "ansible" do |ansible|
    ansible.playbook = "provisioning/mdot-dev.yml"
